...
const Sidebar = styled.aside`
  ...
  background-color: ${colors.menu_sidebar_background};
  padding: 50px;
  width: 50vw;
  height: 100%;
  position: relative;
  ...
  box-shadow: -10px 0px 30px -15px ${colors.menu_sidebar_boxshadow};
...
const NavListItem = styled.li`
  ...
  &:before {
    ...
    color: ${colors.menu_navlinks_number};
